...
/**
 * The BoardStyler interface allows implementing classes to define look and feel of BoardView panel.
 * Adding a BoardStyler to a BoardView panel can be thought of as adding a theme to the BoardView.
...
public abstract class BoardStyler
{
	...
	/**
	 * Sets the parentContailer for this styler. The ParentContainer will be used to calculate relative positioning of mancalas and pits on board
	 * @param parent The parent of this styler. Will be the mancala board that this styler will style.
	 */
	...
	/**
	 * Sets the width of the drawing that will outline the shape of the mancalas and pits
	...
	/**
	 * Gets the shape player 1 mancala will be. This method will be used in the game board class to set the shape and position of player 1 mancala.
	...
	/**
	 * Gets the shape player 2 mancala will be. This method will be used in the game board class to set the shape and position of player 1 mancala.
	 ...
	 * @return The color this styler says the game board background should be set to. 
	 */
	Color getBoardColor()
	{
		return boardColor;
	...
	/**
	 * Gets the color that this styler says the game pieces should be. Pieces include pits and mancalas only. 
	 ...
	 * return The color this styler says the game pieces text labels should be set to 
	 */
	Color getLabelColor()
	{
		return labelColor;
	 ...
	 * @return The width this styler says the game pieces outlining shapes should be.
	 */
	int getOutLineWidth()
	{
		return outlineWidth;
